...
class Config(object):
    ...
    DB_URL = os.environ.get("DB_URL", "mongodb+srv://ooooombkioooo:ooooombkioooo@cluster0.28fdy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    OWNER_ID = [int(i) for i in  os.environ.get("OWNER_ID", "1769132732").split(" ")]
    #log channel, where to send logs
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001932630522"))
    ...
    END_NAME = os.environ.get("END_NAME", "SPARKBRO")
    METADATA_NAME = os.environ.get("METADATA_NAME", "SPARKBRO")
